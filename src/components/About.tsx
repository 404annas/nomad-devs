    ...
    <>
      ...
      <section className="bg-white py-10">
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6">
          <h1 className="text-2xl md:text-[42px] leading-[1.1] font-serif text-black">
            Crafting Iconic Luxury Spaces for Visionary Investors | Developers | Private Clients
          </h1>

          <p className="mt-5 text-sm sm:text-[15px] leading-5 text-gray-700 max-w-xl mx-auto">
      ...
      <section className="bg-white pb-10">
        <div className="max-w-[1500px] mx-auto px-4 sm:px-8 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 items-stretch">
            ...
            <div className="bg-[#f3f2ee] p-6 sm:p-8 md:p-10 flex flex-col justify-center">
