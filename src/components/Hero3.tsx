...
const slides = [
  {
    id: 4,
    src: heroImg4,
    alt: "Bespoke residential interior design and build project in South London",
  },
  {
    id: 1,
    src: heroImg1,
    alt: "Luxury home renovation and design build project in Surrey",
  },
  {
    id: 2,
    src: heroImg2,
    alt: "Modern open-plan interior refurbishment in Central London",
  },
  {
    id: 3,
    src: heroImg3,
    alt: "Premium residential construction and interior design project in North Surrey",
  },
];
