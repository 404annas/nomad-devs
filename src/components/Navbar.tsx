            ...
            `}>
                ...
                <div className="hidden lg:grid grid-cols-3 items-start">
                    ...
                    <div className="flex gap-10 items-center pt-10 justify-start uppercase tracking-tight text-base font-semibold">
                        <a href='tel:078033 2689' className='cursor-pointer hover:opacity-70 transition-opacity'>078033 2689</a>
                        <a href='mailto:hello@designz.dwell-rich.com' className='cursor-pointer hover:opacity-70 transition-opacity'>hello@designz.dwell-rich.com</a>
                    </div>
                </div>
                ...
                `}>
                    ...
                    <div className="bg-[#111] p-8 mt-auto text-white">
                        ...
                        <div className="flex flex-col gap-2">
                            <a href='tel:078033 2689' className='flex items-center gap-4 group cursor-pointer'>
