...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* ======================= */}
      <div
        className={`fixed inset-0 z-[60] lg:hidden transition-all duration-500 ${isMobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
      >
        {/* Backdrop */}
        <div
        ...
        >
          ...
          <div className="bg-[#111] p-8 mt-auto text-white">
            <p className="text-xs text-gray-400 font-medium tracking-widest uppercase mb-6">
              Get in touch
            </p>
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                <span className="text-xs md:text-base font-light tracking-wide break-all">
