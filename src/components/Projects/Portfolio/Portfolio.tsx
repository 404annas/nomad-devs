...
const projects: Project[] = [
    {
        ...
        image: "https://images.squarespace-cdn.com/content/v1/63f8a91775cbc4414ec45764/1679067054845-ZP345N7A5MS5QVK4T6O8/NOMAD-PRIVATE-CLIENTS-3.jpg?format=1500w", // Sketch style house
    },
    {
        id: 2,
        title: "KENSINGTON MANOR",
        location: "SOUTH KENSINGTON",
        image: "https://images.squarespace-cdn.com/content/v1/63f8a91775cbc4414ec45764/7dc5a06c-c8d0-4079-a014-b443223f2f49/NOMAD-INDEX-3.jpg?format=1500w", // Sketch style house
    },
    {
        id: 3,
        title: "CHELSEA TOWNHOUSE",
        location: "CHELSEA",
        image: "https://images.squarespace-cdn.com/content/v1/63f8a91775cbc4414ec45764/1681895748410-3FQOM1NKXNA4QZIOUWZ5/West+Hill+Office.jpg?format=1500w", // Brick building
    },
    {
        id: 4,
        title: "CERTIFIED TOWNHOUSE",
        location: "CERTIFIED",
        image: "https://images.squarespace-cdn.com/content/v1/63f8a91775cbc4414ec45764/7979fa08-a884-4a3a-94b2-b65aa1d8ee6f/NOMAD-CHARTFIELD-8.jpg?format=1500w", // Brick building
    },
];
        ...
        >
            ...
            <div className="w-full h-full flex items-end justify-center">
                ...
                <div className="relative w-full h-full">
                    <Image
                        src={project.image}
                        alt={`${project.title} luxury residential design and build project in ${project.location}`}
                        fill
...
const Portfolio = () => {
    return (
        <section className="w-full pb-10 px-4 md:px-12 bg-white">
            {/* Header Section */}
            <motion.div
